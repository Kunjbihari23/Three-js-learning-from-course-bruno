 ...
 * Lights
 */
const ambientLight = new THREE.AmbientLight(0x00fffc, 1);
// scene.add(ambientLight);
const directionalLight = new THREE.DirectionalLight(0x00fffc, 0.3);
directionalLight.position.set(1, 0.25, 0);
// scene.add(directionalLight);

const hemisphereLight = new THREE.HemisphereLight(0x00fffc, 0x685aff, 1);
// scene.add(hemisphereLight);

const pointLight = new THREE.PointLight(0xffff00, 3, 10, 3);
